...
export declare class ACDappClient {
    ...
    connect({ preferredWalletName }?: Pick<ConnectRequest.Args, 'preferredWalletName'>): Promise<import("@aptos-connect/wallet-api").UserDismissal | import("@aptos-connect/wallet-api").UserApproval<{
