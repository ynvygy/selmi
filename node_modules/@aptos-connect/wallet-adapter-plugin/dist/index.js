...
var _AptosConnectWallet = class _AptosConnectWallet {
  constructor({ network = import_ts_sdk3.Network.MAINNET, preferredWalletName, ...clientConfig }) {
    // endregion
    // region AptosWallet
  ...
  get features() {
    return {
      [import_wallet_standard3.AptosConnectNamespace]: {
        connect: this.connect.bind(this),
        version: "1.0.0"
      },
      [import_wallet_standard3.AptosDisconnectNamespace]: {
        disconnect: this.disconnect.bind(this),
        version: "1.0.0"
      },
      [import_wallet_standard3.AptosGetAccountNamespace]: {
        account: this.getAccount.bind(this),
        version: "1.0.0"
      },
      [import_wallet_standard3.AptosGetNetworkNamespace]: {
        network: this.getNetwork.bind(this),
        version: "1.0.0"
      },
      [import_wallet_standard3.AptosOnAccountChangeNamespace]: {
        onAccountChange: this.onAccountChange.bind(this),
        version: "1.0.0"
      },
      [import_wallet_standard3.AptosOnNetworkChangeNamespace]: {
        onNetworkChange: this.onNetworkChange.bind(this),
        version: "1.0.0"
      },
      [import_wallet_standard3.AptosSignAndSubmitTransactionNamespace]: {
        signAndSubmitTransaction: this.signAndSubmitTransaction.bind(this),
        version: "1.1.0"
      },
      [import_wallet_standard3.AptosSignMessageNamespace]: {
        signMessage: this.signMessage.bind(this),
        version: "1.0.0"
      },
      [import_wallet_standard3.AptosSignTransactionNamespace]: {
...
function registerAptosConnect(config = {}) {
  ...
  (0, import_wallet_standard4.registerWallet)(walletPlugin);
}
