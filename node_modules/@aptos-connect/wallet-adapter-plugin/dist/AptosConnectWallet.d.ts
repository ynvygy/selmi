...
import { AccountInfo, AptosFeatures, AptosSignAndSubmitTransactionFeature, AptosSignAndSubmitTransactionInput, AptosSignAndSubmitTransactionOutput, AptosSignMessageInput, AptosSignMessageOutput, AptosSignTransactionInputV1_1, AptosSignTransactionOutputV1_1, AptosWallet, NetworkInfo, UserResponse } from '@aptos-labs/wallet-standard';
...
export declare class AptosConnectWallet implements AptosWallet {
    private static connectedAccountStorageKey;
    private static get connectedAccount();
    private static set connectedAccount(value);
    ...
    readonly url = "https://aptosconnect.app";
    ...
    constructor({ network, preferredWalletName, ...clientConfig }: AptosConnectWalletConfig);
